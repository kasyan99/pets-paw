...
const limit = response.length
let apiSpy
describe('FavouritiesPage', () => {
   beforeEach(() => {
      jest.clearAllMocks();
   });
   it("getFavourites should be called 1 time", async () => {
      ...
      apiSpy = jest.spyOn(instance, "get");
      apiSpy.mockResolvedValue(response);
      await votingAPI.getFavourites(limit, 0)
